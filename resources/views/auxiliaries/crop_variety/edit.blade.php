                ...
                <div class="card">
                    <div class="card-header d-flex justify-content-between">
                        <div class="header-title">
                            <h4 class="card-title">Editar variedade da cultura</h4>
                        </div>
                    </div>

                    <div class="card-body">
                
                        <form action="{{route('crop_variety.update' ,[ 'crop_variety' => $crop_variety->id ])}}" method="POST"  enctype="multipart/form-data">
                            @method('PATCH')
                            @csrf
